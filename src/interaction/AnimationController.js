 ...
 * Manages lightweight tweens and easing helpers.
 */
...
export class AnimationController {
  ...
  update(currentTime) {
    ...
    this.deltaTime = Math.min(deltaTime, 0.033);
    ...
    for (const [id, anim] of this.animations) {
      ...
      const progress = anim.duration > 0 ? Math.min(anim.time / anim.duration, 1) : 1;
